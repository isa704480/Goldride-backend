...
class UserProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = ['id', 'phone', 'is_verified', 'gold_points', 'id_number', 'referral_code', 'passenger_rating', 'total_passenger_rides', 'has_agreed_to_terms', 'bonus_balance', 'referral_balance', 'pending_referral_bonus', 'created_at', 'is_active', 'referred_by', 'is_blocked', 'block_reason', 'blocked_at']
...
class DriverPublicRegistrationSerializer(serializers.Serializer):
    ...
    vehicle_model = serializers.CharField(max_length=50)
    year = serializers.IntegerField()
    color = serializers.CharField(max_length=10, required=False, default='white')
    plate_number = serializers.CharField(max_length=15)
    vehicle_type = serializers.CharField(max_length=10, default='sedan')
    taxi_park_id = serializers.IntegerField(required=False, allow_null=True)
    # Haydovchi hujjatlari (ixtiyoriy — sayt bosqichma-bosqich formasi yuboradi)
    license_photo = serializers.ImageField(required=False)
    license_photo_back = serializers.ImageField(required=False)
    passport_photo_front = serializers.ImageField(required=False)
    passport_photo_back = serializers.ImageField(required=False)
